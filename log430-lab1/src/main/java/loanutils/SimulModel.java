 ...
 */
public class SimulModel extends AbstractTableModel {
     ...
     */
    public SimulModel(final LoanItem pItem) {
        item = pItem;
    }
    ...
    public Object getValueAt(int pRow, int pCol) {
        switch (pCol) {
            ...
            case 1:
                ...
                return (Double) getValueAt(pRow - 1, 1) * (1D + item.getTaux() / 1200D) - CalcLoanItem.computeMensHorsAss(item);
            case 2:
                if (pRow == 0) {
                    return 0D;
                }
